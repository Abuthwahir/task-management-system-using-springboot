...
public class UserController {
  ...
  public ResponseEntity<UsersResponseDto> getAllManager() {
    ...
    List<User> managers =
        this.userService.getUsersByRoleAndStatus(
            UserRole.MANAGER.value(), UserStatus.ACTIVE.value());
  ...
  public ResponseEntity<UsersResponseDto> getAllEmployee() {
    LOG.info("recieved request for getting ALL Employees!!!");

    UsersResponseDto response = new UsersResponseDto();
    List<User> employees =
        this.userService.getUsersByRoleAndStatus(
            UserRole.EMPLOYEE.value(), UserStatus.ACTIVE.value());
